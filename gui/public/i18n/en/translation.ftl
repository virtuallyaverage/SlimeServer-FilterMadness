...
settings-general-fk_settings-leg_fk-force-reset-hmd-title = Force HMD reset
settings-general-fk_settings-leg_fk-force-reset-hmd-description = Forces the HMD to reset. Useful for wearing an HMD on the forehead.
settings-general-fk_settings-leg_fk-force-reset-hmd = Force HMD reset
